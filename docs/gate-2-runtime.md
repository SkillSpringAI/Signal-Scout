...
> Status: local and deployed runtime verified through Google GenAI SDK, Gemini 3.5 Flash, Firestore Native, and Cloud Run. The current deployed baseline is revision `signal-scout-00016-c9x` from commit `8307d80`, verified on 18 August 2026.

## Refresh-continuity deployment — 18 August 2026

- Revision `signal-scout-00016-c9x` serves 100% of traffic with the existing dedicated runtime identity, Secret Manager reference, Firestore mode, and maximum scale 2.
