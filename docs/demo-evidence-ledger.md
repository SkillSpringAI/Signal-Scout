...
| Cloud Run revision | verified | `signal-scout-00015-g6s`, 100% traffic, default min 0, max 2, dedicated runtime identity, Secret Manager reference, and health pass |
...
| Refresh continuity | verified | fresh deployed tab defaults to Mock; an explicit Live selection survives refresh on `signal-scout-00015-g6s`; only the Live workspace renders after reload; zero browser warnings/errors |
