...
> **Current verified status (16 August 2026):** Signal Scout is publicly deployed on Cloud Run revision `signal-scout-00010-rkb` with a live React/TypeScript UI, bounded Node/TypeScript API, Gemini 3.5 Flash through the Google GenAI SDK, Firestore persistence, sourced Activity evidence, one feedback/adaptation turn, public-demo usage limits, role-specific source hosts, DNS checks, responsive corrections, dynamic live-event identity, and distinct event/project evidence labels. Golden proof scan from the guarded runtime: `b66b7629-26ce-41e6-b9b9-4b6477f56b07`.
